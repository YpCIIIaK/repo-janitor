...
const en = {
  ...
  "share.widgetThemeDark": "Dark",
  "share.widgetThemeLight": "Light",
  "share.widgetEmbedSize": "Embed size",
  "share.widgetSizeCompact": "Compact",
  "share.widgetSizeRoomy": "Roomy",
  "share.widgetBadgeStyle": "Badge style",
  "share.widgetBadgeMessage": "Badge shows",
  "share.widgetMsgBoth": "Grade + score",
  "share.widgetMsgGrade": "Grade only",
  "share.widgetMsgScore": "Score only",
  "share.widgetBadgeLabel": "Badge label",
  "share.widgetShowHeadline": "Headline",
  "share.widgetShowChips": "Severity chips",
  "share.widgetShowMeta": "Scope / scanned",
...
const ru: Messages = {
  ...
  "share.widgetThemeDark": "Тёмная",
  "share.widgetThemeLight": "Светлая",
  "share.widgetEmbedSize": "Размер embed",
  "share.widgetSizeCompact": "Компактный",
  "share.widgetSizeRoomy": "Просторный",
  "share.widgetBadgeStyle": "Стиль бейджа",
  "share.widgetBadgeMessage": "На бейдже",
  "share.widgetMsgBoth": "Оценка + балл",
  "share.widgetMsgGrade": "Только оценка",
  "share.widgetMsgScore": "Только балл",
  "share.widgetBadgeLabel": "Подпись бейджа",
  "share.widgetShowHeadline": "Вердикт",
  "share.widgetShowChips": "Чипы severity",
  "share.widgetShowMeta": "Объём / дата",
