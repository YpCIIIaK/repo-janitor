...
const en = {
  ...
  "drawer.falsePositive": "Report false positive",
  "drawer.falsePositiveHint": "Wrong about this code? Open our issue form with the scanner and location already filled in",
...
const ru: Messages = {
  ...
  "drawer.falsePositive": "Ложное срабатывание",
  "drawer.falsePositiveHint": "Проверка неправа насчёт этого кода? Откроется наша форма с уже заполненными сканером и местом",
